$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        var prefix_path='/bundles/pletnevprojectmanager/';
        if (themeName == 'classic') {
            $('#bs-css').attr('href', prefix_path+'bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', prefix_path+'css/bootstrap-' + themeName + '.min.css');
        }
